...
def notacao_hora(hora,minuto):
    

    #não confere hora inválida
...
print(notacao_hora(95,25))
print(notacao_hora(15,25))
print(notacao_hora(8,25))
print(notacao_hora(12,25))
print(notacao_hora(24,25))