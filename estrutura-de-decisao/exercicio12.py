...
print(f"(-) IR ({percentual_ir}): {desconto_ir:.2f}")
print(f"(-) INSS (10%): {desconto_inss:.2f}")
print(f"(-) Sindicato (3%): {desconto_sindicato:.2f}")
print(f"FGTS (11%): {fgts:.2f}")
print(f"Total de dscontos: {total_descontos:.2f}")
